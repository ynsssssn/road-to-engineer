...
- **AWS Lambda + GAS 서버리스 구성**: 추가 인프라 유지비 없는 완전한 서버리스 구조를 직접 설계하여 AWS Free Tier 범위 내 $0 비용으로 완전 자동화를 달성했습니다.
...
### 3. 프로젝트 주요 성과
- **💰 연 1,400만 원 비용 절감**: 외부 유료 SaaS 도입 대비 인프라 구축 비용을 100% 절감하여 연간 1,400만 원의 고정비를 줄였습니다.
